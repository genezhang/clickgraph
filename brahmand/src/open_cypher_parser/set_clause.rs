...
pub fn parse_set_clause(input: &str) -> IResult<&str, SetClause, OpenCypherParsingError> {
...
fn set_item_parser(input: &str) -> IResult<&str, OperatorApplication, OpenCypherParsingError> {
