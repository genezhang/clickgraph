...
SELECT Post_id AS Message_id, Person_id AS Person_id FROM ldbc.Post_hasCreator_Person
UNION ALL
SELECT Comment_id AS Message_id, Person_id AS Person_id FROM ldbc.Comment_hasCreator_Person;
...
SELECT Person_id AS Person_id, Post_id AS Message_id, creationDate FROM ldbc.Person_likes_Post
UNION ALL
SELECT Person_id AS Person_id, Comment_id AS Message_id, creationDate FROM ldbc.Person_likes_Comment;