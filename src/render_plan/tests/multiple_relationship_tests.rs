...
use crate::{
    ...
    graph_catalog::schema_types::SchemaType, open_cypher_parser,
...
fn setup_test_schema() {
    ...
    relationships.insert(
        ...
        RelationshipSchema {
            ...
            from_node_table: "users".to_string(),
            to_node_table: "users".to_string(),
            from_id: Identifier::from("user1_id"),
            to_id: Identifier::from("user2_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
    ...
    relationships.insert(
        ...
        RelationshipSchema {
            ...
            to_id: Identifier::from("product_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
    ...
    relationships.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("customer_id"),
            to_id: Identifier::from("order_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
    ...
    nodes.insert(
        ...
        NodeSchema {
            ...
            node_id: NodeIdSchema::single("product_id".to_string(), SchemaType::Integer),
            property_mappings: HashMap::new(),
            view_parameters: None,
            engine: None,
            use_final: None,
