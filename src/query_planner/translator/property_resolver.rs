...
mod tests {
    ...
    fn create_standard_view_scan(table: &str) -> ViewScan {
        ...
        property_mapping.insert("name".to_string(), PropertyValue::Column("username".to_string()));
        property_mapping.insert("email".to_string(), PropertyValue::Column("email_address".to_string()));
    ...
    fn create_denormalized_view_scan(table: &str) -> ViewScan {
        let mut property_mapping = HashMap::new();
        property_mapping.insert("distance".to_string(), PropertyValue::Column("Distance".to_string()));
    ...
    fn test_standard_property_resolution() {
        ...
        assert_eq!(result.property_value, PropertyValue::Column("username".to_string()));
    ...
    fn test_polymorphic_with_type_filters() {
        ...
        let mut property_mapping = HashMap::new();
        property_mapping.insert("date".to_string(), PropertyValue::Column("interaction_date".to_string()));
        ...
        assert_eq!(result.property_value, PropertyValue::Column("interaction_date".to_string()));
    ...
    fn test_missing_property_returns_error() {
        ...
        assert!(result.unwrap_err().to_string().contains("not found in property_mapping"));
    }
    ...
    fn test_denormalized_from_property_resolution() {
        ...
        assert_eq!(result.property_value, PropertyValue::Column("OriginCityName".to_string()));
        assert_eq!(result.type_filters.len(), 0);
    }
    ...
    fn test_denormalized_to_property_resolution() {
        ...
        assert_eq!(result.table_alias, "f");
        assert_eq!(result.property_value, PropertyValue::Column("DestCityName".to_string()));
    }
    ...
    fn test_denormalized_multi_hop_different_properties() {
        ...
        assert_eq!(result_f.property_value, PropertyValue::Column("DestCityName".to_string()));
        ...
        assert_eq!(result_g.property_value, PropertyValue::Column("OriginCityName".to_string()));
