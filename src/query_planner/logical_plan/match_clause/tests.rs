...
fn create_test_schema_with_relationships() -> GraphSchema {
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("from_airport"),
            to_id: Identifier::from("to_airport"),
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("person_id"),
            to_id: Identifier::from("org_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("emp_id"),
            to_id: Identifier::from("proj_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("user_id"),
            to_id: Identifier::from("system_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
...
fn create_single_relationship_schema() -> GraphSchema {
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("person1_id"),
            to_id: Identifier::from("person2_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
...
fn test_infer_node_label_denormalized_single_node() {
    ...
    nodes.insert(
        ...
        NodeSchema {
            ...
            node_id: NodeIdSchema::single("Origin".to_string(), SchemaType::String),
            property_mappings: HashMap::new(),
            view_parameters: None,
            engine: None,
            use_final: None,
...
fn test_infer_relationship_type_polymorphic_edge() {
    ...
    rels.insert(
        ...
        RelationshipSchema {
            ...
            from_id: Identifier::from("member_id"),
            to_id: Identifier::from("group_id"),
            from_node_id_dtype: SchemaType::Integer,
            to_node_id_dtype: SchemaType::Integer,
            property_mappings: HashMap::new(),
            view_parameters: None,
