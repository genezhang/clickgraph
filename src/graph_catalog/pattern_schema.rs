...
impl PatternSchemaContext {
    ...
    #[allow(clippy::too_many_arguments)] // mirrors `analyze` inputs needed for join-strategy decisions; private helper, factoring would only relocate the wide signature
