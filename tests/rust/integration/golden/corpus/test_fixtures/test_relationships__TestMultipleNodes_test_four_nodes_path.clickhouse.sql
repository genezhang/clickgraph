...
WHERE ((((d.name = 'Eve' AND a.name = 'Alice') AND (t2.follower_id <> t1.follower_id OR t2.followed_id <> t1.followed_id)) AND (t2.follower_id <> t0.follower_id OR t2.followed_id <> t0.followed_id)) AND (t1.follower_id <> t0.follower_id OR t1.followed_id <> t0.followed_id))
