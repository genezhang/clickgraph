...
with_hops_path_nodes_path_rels_u1_u2_cte_0 AS (SELECT 
...
SELECT 
      hops_path_nodes_path_rels_u1_u2.p2_u1_name AS "u1.name", 
      hops_path_nodes_path_rels_u1_u2.p2_u2_name AS "u2.name", 
      hops_path_nodes_path_rels_u1_u2.hops AS "hops", 
      length(hops_path_nodes_path_rels_u1_u2.path_nodes) AS "node_count", 
      length(hops_path_nodes_path_rels_u1_u2.path_rels) AS "rel_count"
FROM with_hops_path_nodes_path_rels_u1_u2_cte_0 AS hops_path_nodes_path_rels_u1_u2
