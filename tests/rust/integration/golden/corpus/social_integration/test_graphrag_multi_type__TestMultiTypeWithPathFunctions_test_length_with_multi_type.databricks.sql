...
UNION ALL 
SELECT 
      struct('fixed_path', 'u', 'x', 't0') AS `p`,
      to_json(struct(u.age AS _s_age, u.city AS _s_city, u.country AS _s_country, u.email_address AS _s_email, u.is_active AS _s_is_active, u.full_name AS _s_name, u.registration_date AS _s_registration_date, u.user_id AS _s_user_id)) AS `_start_properties`,
      to_json(struct(x.age AS _e_age, x.city AS _e_city, x.country AS _e_country, x.email_address AS _e_email, x.is_active AS _e_is_active, x.full_name AS _e_name, x.registration_date AS _e_registration_date, x.user_id AS _e_user_id)) AS `_end_properties`,
      '{}' AS `_rel_properties`,
