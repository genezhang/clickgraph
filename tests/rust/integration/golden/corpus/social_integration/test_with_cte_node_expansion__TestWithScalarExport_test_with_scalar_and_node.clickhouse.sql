WITH with_a_follower_count_cte_0 AS (SELECT 
      anyLast(a.age) AS "p1_a_age", 
      anyLast(a.city) AS "p1_a_city", 
      anyLast(a.country) AS "p1_a_country", 
      anyLast(a.email_address) AS "p1_a_email", 
      anyLast(a.is_active) AS "p1_a_is_active", 
      anyLast(a.full_name) AS "p1_a_name", 
      anyLast(a.registration_date) AS "p1_a_registration_date", 
