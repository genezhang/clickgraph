WITH with_a_friends_cte_0 AS (SELECT 
      ...
      groupArray(t0.followed_id) AS "friends"
...
with_a_c_cte_1 AS (SELECT 
      ...
      arrayCount(x -> x IN (SELECT __r0.follower_id FROM test_integration.user_follows_test AS __r0 INNER JOIN test_integration.user_follows_test AS __r1 ON __r0.followed_id = __r1.follower_id), a_friends."friends") AS "c"
