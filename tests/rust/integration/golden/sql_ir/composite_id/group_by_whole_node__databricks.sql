SELECT 
      any_value(a.account_number) AS `a.account_number`, 
      any_value(a.account_type) AS `a.account_type`, 
      any_value(a.balance) AS `a.balance`, 
      a.bank_id AS `a.bank_id`, 
      any_value(a.holder_name) AS `a.holder_name`, 
      any_value(a.opened_date) AS `a.opened_date`, 
