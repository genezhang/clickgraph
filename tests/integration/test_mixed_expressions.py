...
if __name__ == "__main__":
    ...
    try:
        ...
        print("  export GRAPH_CONFIG_PATH=benchmarks/social_network/schemas/social_integration.yaml")
        print("  cargo run --bin clickgraph -- --http-port 8080 --disable-bolt")
        sys.exit(1)
    
    # Run tests
    print("\nNote: Switch schema between runs with GRAPH_CONFIG_PATH")
    print("  Standard: benchmarks/social_network/schemas/social_integration.yaml")
