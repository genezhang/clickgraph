...
- **#504/#529/#461 (coupled-schema / post-WITH legacy-optional family) — R4/R5: two of #529 shape 1's three bugs FIXED, a loud guard added for the third (widened in R5 after adversarial review found the first guard scoping missed several shapes — see below); one of #461 shape 1's three downstream symptom bugs FIXED (a second attempted and reverted after it regressed other tests; a fourth, deeper cause found but not fixed); #504 remains deferred**:
